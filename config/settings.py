...
REST_FRAMEWORK = {
    ...
    #     # "apps.account.services.auth.authentication.CustomUserAuthentication", TODO: Использовать при получении токена через админку
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Автодокументация системы бронирования",
    "VERSION": VERSION,
...
EMAIL_HOST_USER = env("EMAIL_HOST_USER", default="lucky11kononov@yandex.ru")
EMAIL_HOST_PASSWORD = env("EMAIL_HOST_PASSWORD", default="fckttihexkrkprep")
