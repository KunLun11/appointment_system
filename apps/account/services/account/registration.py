...
from apps.account.services.account.verification import VerificationService
from apps.account.services.auth.factory import TokenFactory
from apps.employee.models.employees import Client, ProfileClient
...
class RegistrationService:
    ...
    def verify_user_email(email: str, confirmation_code: str) -> CustomUser:
        ...
        profile = ProfileClient.objects.create(
            first_name=user.first_name or "",
            last_name=user.last_name or "",
            phone=user.phone or "",
            email=user.email or "",
        )
        client = Client.objects.create(user=user, profile=profile)
